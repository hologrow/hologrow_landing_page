# Privacy Policy for Hologrow

## Introduction

Welcome to Hologrow, the **Personalized Video Growth Engine** designed to help you build AI-driven video content for e-commerce. At Hologrow, your privacy is of utmost importance to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services.
...
2. **Usage Details**
   ...
   - **What We Collect**: Information about how you use Hologrow, including your interactions, features accessed, and usage frequency.
   - **Purpose**: To analyze user engagement and improve our services.

3. **Device Information**

   - **What We Collect**: Data regarding the devices you use to access Hologrow, such as device type, operating system, and browser type.
...
**Copyright Owner**: [hologrow.ai](http://hologrow.ai)
**Email**: [support@hologrow.ai](mailto:support@hologrow.ai)

By using Hologrow, you consent to our privacy policy and agree to its terms. Thank you for trusting us with your information!
