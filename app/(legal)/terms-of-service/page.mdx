...
Welcome to **Hologrow**, a Personalized Video Growth Engine designed for building AI-driven video content for e-commerce. By accessing or using our service, you agree to be bound by these Terms of Service. If you do not agree with any of these terms, please do not use our service.

## Use of the Service

Hologrow provides users with a comprehensive platform to build and launch personalized video content for e-commerce using our AI-driven growth engine. You agree to use the service in accordance with all applicable local, state, national, and international laws and regulations.
...
All content provided through Hologrow, including but not limited to video generation tools, AI models, infrastructure setup, and documentation, is protected under copyright law. The copyright owner of Hologrow is **hologrow.ai**.

- You acknowledge that you do not own the underlying technology or intellectual property that makes up the Hologrow service, and you agree to respect the intellectual property rights of hologrow.ai and any third parties.
- While you retain ownership of your custom implementations and modifications, the core Hologrow platform and tools remain the property of hologrow.ai.
...
- Reselling or redistributing Hologrow tools without authorization
...
Hologrow collects the following types of data:
...
To the fullest extent permitted by law, hologrow.ai shall not be liable for any direct, indirect, incidental, special, consequential, or punitive damages arising from the use of or inability to use the service.

## Indemnification

You agree to indemnify and hold harmless hologrow.ai, its affiliates, and their respective officers, directors, employees, and agents from any claims, damages, losses, liabilities, and expenses (including attorneys' fees) arising from your use of the service or violation of these Terms.

## Governing Law and Dispute Resolution

These Terms shall be governed by and construed in accordance with the laws of the jurisdiction in which hologrow.ai operates, without regard to its conflict of law provisions. Any disputes arising from these Terms or the service will be resolved through binding arbitration in accordance with applicable laws.
...
If you have any questions about these Terms, please contact us at [support@hologrow.ai](mailto:support@hologrow.ai).

---

By using Hologrow, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service. Thank you for choosing Hologrow!
